#' The snapper animals file
#'
#' A dataset containing snapper information
#'
...
#'  \item{Measurement}{Factor values. Representing the type of measuremnt taken}
#'  \item{MeasureValue}{Numeric Value. Represnting the value of the measuremnt taken}
#'  \item{MeasurementUnit}{Factor values. Representing the unit of the measurement taken}
#' }
